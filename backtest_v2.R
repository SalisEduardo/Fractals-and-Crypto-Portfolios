...
# Modifyed functions
execute_defaultpolicies_v2 <- function(opt,asset_names,train,test,status_efficiency ="most"){
  # Specs
...
compleate_backtest_v2 <- function(periods_keyval,optm='DEoptim',portfolio_sizes=c(4,6,8)){
...
KPIS_backtest_index  %>%  writexl::write_xlsx("Results/Complete_Backtest/BacktestKPIs_index.xlsx")



# Selected Cryptos 4, 6 , 8
STRATS_DEOPTM_468 <- compleate_backtest_v2(PERIODS,optm = 'DEoptim')
